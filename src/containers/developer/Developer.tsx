    ...
    <Container>
      <div className="wrap-container">
              ...
              <CopyContainer>
                <pre className="pre">
                  ...
                  <div className="icCopy" onClick={() => onClickCopy(DocumentData[currentIndex].code)}>
                    <img alt="ic-copy" src={`${CDN_URL}/icons/ic-copy.svg`}></img>
                  </div>
                </pre>
              </CopyContainer>
            </div>
        ...
        <div className="btnFaq" onClick={onClickFAQ}>
          ...
          <img alt="icon" className="icon" src={`${CDN_URL}/icons/ic-chevron-down.svg`} />
        </div>
      </div>
  ...
  return (
    <StyledFAQItem isSelected={isOpen}>
      <div className="header" onClick={() => setIsOpen(!isOpen)}>
        ...
        <img alt="icon" className="icon" src={`${CDN_URL}/icons/ic-chevron-right.svg`} />
      </div>

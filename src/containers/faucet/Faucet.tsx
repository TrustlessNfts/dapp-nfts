...
const Faucet = () => {
  ...
  const handleLoaded = () => {
    Object(window).grecaptcha.ready(() => {
      Object(window).grecaptcha.execute(siteKey, { action: 'homepage' }).then((token: string) => {
        onVerify(token);
      });
    });
  };
            ...
            <PostStep className="post" disable={currentStep > 1}>
              ...
              >
                <div className="postBtn">
                  <img alt="ic-twitter" src={`${CDN_URL}/icons/ic_twitter_black.svg`} />
